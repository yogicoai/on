...
async function listPromotions(mall) {
  ...
  try {
    ...
    return arr.map((d) => ({ id: String(d._id), mall: d.mall, name: d.name, start: d.start, end: d.end, memo: d.memo || '', products: d.products || [], coupons: d.coupons || [], updatedAt: d.updatedAt }));
  } catch (_) { return []; }
}
