...
function build() {
  ...
  server.registerTool('alerts', {
    ...
    description: '매출 급락(전주 동요일比)·광고비/ROAS 이상·트래픽 급락·미답변 문의(3일 경과 시 심각)·재고 소진 임박·월 목표 페이스 미달·스토어 반품/취소 급등을 자동 스캔 → 심각도(🔴🟡)순 경보 목록. ' +
      '"오늘 챙길 거 있어?", "이상 없어?", "경보 확인", "뭐 문제 있어?" 같은 질문엔 여러 도구 대신 이 도구 하나만 호출. 스캔에 10~30초 걸릴 수 있음.',
    inputSchema: {},
  }, wrap(() => alerts.scan()));
